    ...
    def url_second(self):
            ...
            for i in url:
                if a<=420:
                    ...
                    yzs=content.xpath("//div[@class='sons']/div[@class='contyishang']//text()")
                    # print(yzs)
                    # text_str=''
                    # text_str=' '.join(yzs)#将列表转变成字符串
                    # text_str=text_str.replace(" ","").replace("\u3000","")
                    # text_str=text_str.replace("\n","")
                    # text_str=text_str.replace("\r\n","")
                    # text_str=text_str.replace("展开阅读全文∨","")
                    # text_str=text_str.replace("译文及注释","")
                    # text_str=text_str.replace("译文","*").replace("注释","*").replace("赏析","*")
                    # print(text_str)
...
#               print(i)
            ...
            for i in range(len(yizhushang)):
                yizhushang[i]=str(yizhushang[i])
                yizhushang[i]=yizhushang[i].replace(" ","").replace("\u3000","").replace("\n","").replace("\r\n","").replace("展开阅读全文∨","").replace("译文及注释","").replace("译文","*").replace("注释","*").replace("赏析","*").replace("'\n'","*")
          #       print(yizhushang[i])
            #   print(poem)
            # print(i)
            # print(poem_name)
